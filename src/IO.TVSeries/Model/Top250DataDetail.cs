...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Top250DataDetail :  IEquatable<Top250DataDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Top250DataDetail" /> class.
        /// </summary>
        ...
        public Top250DataDetail(string id = default(string), string rank = default(string), string title = default(string), string fullTitle = default(string), string year = default(string), string image = default(string), string crew = default(string), string imDbRating = default(string), string imDbRatingCount = default(string))
        {
            this.Id = id;
            this.Rank = rank;
            this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Top250DataDetail {\n");
        ...
        {
            return this.Equals(input as Top250DataDetail);
        }

        /// <summary>
        /// Returns true if Top250DataDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of Top250DataDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Top250DataDetail input)
        {
            if (input == null)
                return false;
