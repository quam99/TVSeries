...
namespace IO.Swagger.Client
{
    ...
    {
        private const string apiKey = "k_hh8pxhdt";
        string apiKeyManual = "";
        ...
        private void btnSeries1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var deserializedResponse = JsonConvert.DeserializeObject<Model.SearchData>(responseData_);
        ...
        private void btnScanSeries_Click(object sender, EventArgs e)
        {
            ...
            ds1TableAdapters.IMDbSeriesTableAdapter sqlAdapter1 = new ds1TableAdapters.IMDbSeriesTableAdapter();
            ds1TableAdapters.IMDbSeriesInfoTableAdapter sqlAdapter2 = new ds1TableAdapters.IMDbSeriesInfoTableAdapter();
            ...
            using (mgr1.IMDbSeriesInfoTableAdapter = sqlAdapter2)
            {
                ...
                mgr1.UpdateOrder = ds1TableAdapters.TableAdapterManager.UpdateOrderOption.InsertUpdateDelete;
        ...
        private void btnSeasonEp_Click(object sender, EventArgs e)
        {
            ...
            if (cbARFetch.Checked)  // Based to IMDBSeries table retreives data from IMDB api for all series  
            {
                responseData_ = null;
                ds1TableAdapters.TableAdapterManager mgr1 = new ds1TableAdapters.TableAdapterManager();
                ds1TableAdapters.IMDbSeriesInfoTableAdapter sqlAdapter1 = new ds1TableAdapters.IMDbSeriesInfoTableAdapter();
                ds1TableAdapters.IMDbEpisodesTableAdapter sqlAdapter2 = new ds1TableAdapters.IMDbEpisodesTableAdapter();
                        ...
                        if (dt.TableName == "IMDbSeriesInfo")
                        {
                            ...
                            SerieFetch:    //SeasonFetched : 1=All seasons saved , 100=No data returned for the serie/season
                                ...
                                foreach (DataRow row in dt.Select("Seasons > 0 AND SeasonFetched is NULL", "Seasons DESC, Id"))
                                {
                                    ...
                                    //lastupdate = String.Format("{0}", row["Lastupdate"]);
                                    //lastSeasonRec = ds1.Tables[2].AsEnumerable().Where(tr => (string)tr["IMDbId"] == serieId).Max(tr => (Int16)tr["SeasonNumber"]);
                                    //lastSeasonRec = ds1.Tables[2].Where(e => e.IMDbId == serieId).Max(e => e.SeasonNumber);
