...
namespace IO.TVSeries.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class IMDbListDataDetail :  IEquatable<IMDbListDataDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IMDbListDataDetail" /> class.
        /// </summary>
        ...
        public IMDbListDataDetail(string id = default(string), string index = default(string), string title = default(string), string fullTitle = default(string), string year = default(string), string image = default(string), string imDbRating = default(string), string imDbRatingCount = default(string), string description = default(string))
        {
            this.Id = id;
            this.Index = index;
            this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IMDbListDataDetail {\n");
        ...
        {
            return this.Equals(input as IMDbListDataDetail);
        }

        /// <summary>
        /// Returns true if IMDbListDataDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of IMDbListDataDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IMDbListDataDetail input)
        {
            if (input == null)
                return false;
