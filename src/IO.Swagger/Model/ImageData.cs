...
namespace IO.TVSeries.Model
{
        ...
        public partial class ImageData :  IEquatable<ImageData>, IValidatableObject
    {
        ...
        public ImageData(string imDbId = default(string), string title = default(string), string fullTitle = default(string), string type = default(string), string year = default(string), List<ImageDataDetail> items = default(List<ImageDataDetail>), string errorMessage = default(string))
        {
            this.ImDbId = imDbId;
            this.Title = title;
